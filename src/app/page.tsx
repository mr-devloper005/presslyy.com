...
function getDirectoryTone(brandPack: string) {
  if (brandPack === 'market-utility') {
    return {
      ...
      hero: 'bg-[linear-gradient(180deg,#fdf5fb_0%,#faf0f8_100%)]',
      panel: 'border border-[#e6d4e0] bg-white shadow-[0_24px_64px_rgba(91,43,59,0.08)]',
      soft: 'border border-[#e6d4e0] bg-[#f5eef2]',
      muted: 'text-[#7a5d6b]',
      title: 'text-[#5B2B3B]',
      badge: 'bg-[#5B2B3B] text-[#fdf5fb]',
      action: 'bg-[#5B2B3B] text-[#fdf5fb] hover:bg-[#4a2238]',
      actionAlt: 'border border-[#e6d4e0] bg-white text-[#5B2B3B] hover:bg-[#f5eef2]',
    }
  }
  return {
    shell: 'bg-[#f8f0f7] text-[#5B2B3B]',
...
function getEditorialTone() {
  return {
    ...
    badge: 'bg-[#5B2B3B] text-[#fdf5fb]',
    action: 'bg-[#5B2B3B] text-[#fdf5fb] hover:bg-[#4a2238]',
    actionAlt: 'border border-[#e6d4e0] bg-transparent text-[#5B2B3B] hover:bg-[#f5eef2]',
  }
}
...
function getVisualTone() {
  return {
    ...
    muted: 'text-[#f5eef2]',
    title: 'text-white',
    badge: 'bg-[#FF47DA] text-[#5B2B3B]',
    action: 'bg-[#FF47DA] text-[#5B2B3B] hover:bg-[#e639b8]',
